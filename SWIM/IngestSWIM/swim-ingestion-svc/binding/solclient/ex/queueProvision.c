 ...
 *
 * Copyright 2009-2016 Solace Systems, Inc. All rights reserved.
 */
...
sendQueueMessage ( char *queueName, solClient_opaqueSession_pt session_p )
{
...
main ( int argc, char *argv[] )
{
    ...
    printf ( "\nqueueProvision.c (Copyright 2009-2016 Solace Systems, Inc. All rights reserved.)\n" );
    ...
    while ( !gotCtlC ) {
        if ( ( rc = sendQueueMessage ( provQueueName, session_p ) ) != SOLCLIENT_OK ) {
