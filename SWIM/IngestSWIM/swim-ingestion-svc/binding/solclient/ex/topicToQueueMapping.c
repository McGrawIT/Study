...
main ( int argc, char *argv[] )
{
    ...
    printf ( "\ntopicToQueueMapping.c (Copyright 2010-2016 Solace Systems, Inc. All rights reserved.)\n" );
    ...
    solClient_log ( SOLCLIENT_LOG_INFO, "Adding subscription %s to queue %s via flow.", topic_p[0], COMMON_TESTQ );
